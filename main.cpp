...
{
    Q_OBJECT
    Q_PLUGIN_METADATA(IID "org.qt-project.Qt.QPA.QPlatformIntegrationFactoryInterface.5.1" FILE "eglfsvb.json")
public:
...
{
    Q_UNUSED(paramList);
    if (system.toLower() == "eglfsvb")
        return new QEglFSVBIntegration;
